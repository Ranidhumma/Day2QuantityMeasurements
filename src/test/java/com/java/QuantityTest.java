...
public class QuantityTest {
	...
	public void given0Feetand0Feet_ShouldReturnEqual() {
		...
		double value1 = qMeasurement1.unitCompare(Unit.FEET, 0.0);
		double value2 = qMeasurement1.unitCompare(Unit.FEET, 0.0);
	...
	public void given1feetandNullShouldReturNotEqual() {
		double value1 = qMeasurement1.unitCompare(Unit.FEET, 1.0);
	...
	public void given1Inchand1InchShouldReturEqual() {
		double value1 = qMeasurement1.unitCompare(Unit.INCH, 1.0);
		double value2 = qMeasurement1.unitCompare(Unit.INCH, 1.0);
	...
	public void given0Inchand0InchShouldReturEqual() {
		double value1 = qMeasurement1.unitCompare(Unit.INCH, 0.0);
		double value2 = qMeasurement1.unitCompare(Unit.INCH, 0.0);
		Assert.assertEquals(value1, value1, 0.0);
	}
	...
	public void given3feetand1YardShouldReturnTrue() {
		double value1 = qMeasurement1.unitCompare(Unit.FEET, 3.0);
	...
	public void given1YardAnd36Inch_ShouldReturnEqual() {
		double value1 = qMeasurement1.unitCompare(Unit.YARD, 1.0);
		double value2 = qMeasurement1.unitCompare(Unit.INCH, 36.0);
		Assert.assertEquals(value1, value2, 0.0);
	}
	...
	public void given36InchAnd1YardShouldReturnEqual() {
		double value1 = qMeasurement1.unitCompare(Unit.INCH, 36.0);
		double value2 = qMeasurement1.unitCompare(Unit.YARD, 1.0);
		Assert.assertEquals(value1, value2, 0.0);
	}
